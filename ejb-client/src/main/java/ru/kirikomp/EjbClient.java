...
import ru.kirikomp.service.ToDoServiceRemote;
...
public class EjbClient {
    ...
    public static void main(String[] args) throws IOException, NamingException, ExecutionException, InterruptedException {
        ...
        ToDoServiceRemote todoService = (ToDoServiceRemote) context.lookup("ejb:/jee-servlet/ToDoServiceImpl!ru.kirikomp.service.ToDoServiceRemote");
